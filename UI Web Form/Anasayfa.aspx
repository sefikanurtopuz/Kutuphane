<%@ Page Title="" Language="C#" MasterPageFile="~/Ana.Master" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="UI_Web_Form.Anasayfa" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="2px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="ISBN" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        <Columns>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="card">
        <div class="card-body">
            ...
            &nbsp;
            <asp:Button ID="btnKitapSil" runat="server" Text="Sil" class="btn btn-outline-dark" OnClick="btnKitapSil_Click" OnClientClick="return confirm('Silmek istediğinize emin misiniz?');" />
            &nbsp;
        </div>
    </div>
    <br />
