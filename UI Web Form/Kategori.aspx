...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="card">
        <div class="card-body">
            <asp:Label ID="Label1" runat="server" Text="Kategori No" class="fw-bold text-decoration-underline"></asp:Label>
            <asp:Label ID="lblKategoriId" runat="server" Text="" class="fst-normal"></asp:Label>
            <br />
            <asp:Label ID="Label2" runat="server" Text="Kategori Adı" class="fw-bold text-decoration-underline"></asp:Label>
            ...
            &nbsp;
            <asp:Button ID="btnKategoriSil" runat="server" Text="Sil" class="btn btn-outline-dark" OnClick="btnKategoriSil_Click" OnClientClick="return confirm('Silmek istediğinize emin misiniz?');" />
            &nbsp;
        </div>
    </div>
